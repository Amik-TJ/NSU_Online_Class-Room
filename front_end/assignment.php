<?php
    ...
    $success = $_SESSION['ass_res']['success'];
    if($success){
        $ass_res = $_SESSION['ass_res']['data'];
    }
            ...
            <div class="row" >
                ...
                <div class="col-md-6">
                    ...
                    if($success){
                        ...
                        echo '</thead>';
                        echo '<tbody>';
                        foreach ( $ass_res as $as){
                            $due = strtotime($as['assignment_due_date']);
                            $due = date('d F Y' , $due);
                            $time = strtotime($as['created_time']);
                            $time = date('d F Y' , $time);
                            echo '<tr>';
                            echo '<th scope="row">';
                            echo $as['assignment_title'];
                            echo '</th>';
                            echo '<td>';
                            echo $as['post_text'];
                            echo '</td>';
                    ...
                    }else
                    {
                        ...
                        echo "Hurray ! There is No Assignments!!";
                        echo '</h2>';
                    }
                    ?>
